...
def _run_query(sql: str, db_path: str, params: tuple = ()) -> pl.DataFrame:
...
def get_abc_classification(db_path: str) -> pl.DataFrame:
    """
    Returns ABC classification of products based on revenue.
